...
<html>
    ...
    <nav>
        ...
        <ul id="menuGeneral">
            ...
            <li id="logo"><a href="./?action=accueil"><img src="img/logo2(1).png" width="75" height="80" alt="logo" /></a></li>
            <li><a href="./?action=partager">Partager une table</a></li>
    ...
    <ul id="menuContextuel">
        <li><img src="img/logo2(1).png" width="75" height="80" alt="logo" /></li>
